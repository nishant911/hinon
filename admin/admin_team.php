				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<form role="form" name="forms" method="post"
								enctype="multipart/form-data" action="admin_team_action.php">
								<div class="box-body">
					...
					<div class="col-xs-12">
						...
						<div class="box">
							...
							<!-- /.box-header -->
							<form role="form" name="forms" method="post"
								enctype="multipart/form-data" action="admin_team_delete.php">
								<div class="box-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
							         		  ...
							         		  <tr>
												...
												<td><a href="websitecontent/<?php echo $row['image']; ?>" /> <?php echo $row['image']; ?></td>
