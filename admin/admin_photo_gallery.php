...
<body class="skin-blue">
	<div class="wrapper">
      ...
      <!-- Right side column. Contains the navbar and content of the page -->
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<form role="form" name="forms" method="post"
								...
								action="admin_photo_gallery_action.php">
								<div class="box-body">
									<!--       
                <div class="form-group">
                      <label>Product Content </label>
                      <input type="text" name="product_content" class="form-control" placeholder="Enter Product Content..."/>
                    </div>
              -->
									<div class="form-group">
					...
					<div class="col-xs-12">
						...
						<div class="box">
							...
							<form role="form" name="forms" method="post"
								enctype="multipart/form-data"
								action="admin_photo_gallery_delete.php">
								<div class="box-body">
        ...
        <?php
        $con = OpenCon();
        $query_photo = "select * from photo_gallery";
        ...
        while ($row_photo = mysqli_fetch_array($result_photo)) {
           ...
           <tr>
												<td><?php echo $i; ?></td>
												<td><a
													href="websitecontent/<?php echo $row_photo['upload_image']; ?>" /> <?php echo $row_photo['upload_image']; ?></td>
												<td><input type="checkbox" name="checkbox[]"
													value="<?php echo $row_photo['id']; ?>"></td>
											</tr>
