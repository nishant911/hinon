		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">User Account History</h3>
							</div>
							<!-- /.box-header -->
                    ...
                    $query = "select * from wallet where sponsor_id='$_SESSION[member_id]' ";
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        $i ++;
                        $current_balance = $current_balance + $row['amount'] - $row['debit'];
