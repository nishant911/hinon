			...
			<section class="content">
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<form role="form" name="forms" method="post"
								enctype="multipart/form-data" action="admin_clients_action.php">
					...
					<div class="box">
						...
						<!-- /.box-header -->
						<form role="form" name="forms" method="post"
							enctype="multipart/form-data" action="admin_clients_delete.php">
							<div class="box-body">
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
											...
											<td><?php echo $i; ?></td>
											<td><a
												href="websitecontent/<?php echo $row_clients['upload_image']; ?>" /> <?php echo $row_clients['upload_image']; ?></td>
											<td><input type="checkbox" name="checkbox[]"
												value="<?php echo $row_clients['id']; ?>"></td>
										</tr>
