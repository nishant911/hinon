	...
	<div class="wrapper">
      ...
      <!-- Right side column. Contains the navbar and content of the page -->
		<div class="content-wrapper">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<form role="form" name="forms" method="post"
								...
								action="admin_video_gallery_action.php">
								<div class="box-body">

									<div class="form-group">
										<label>Video Caption </label> <input type="text"
											name="video_caption" class="form-control"
											placeholder="Enter Product Content..." />
									</div>

									<div class="form-group">
										<label>Video Link</label> <input type="text" name="video_link"
											class="form-control" placeholder="Enter Video Gallery Link.." />
									</div>
								</div>
								<!-- /.box-body -->
					...
					<div class="col-xs-12">
						...
						<div class="box">
							...
							<form role="form" name="forms" method="post"
								enctype="multipart/form-data"
								action="admin_video_gallery_delete.php">
								<div class="box-body">
                     ...
                     <?php
                     $con = OpenCon();
                    $query_video = "select * from video_gallery";
                    $result_video = mysqli_query($con, $query_video);
                    mysqli_close($con);
                    $i = 0;
           ...
           <tr>
												<td><?php echo $i; ?></td>
												<td><?php echo $row_video['video_caption']; ?></td>
												<td><a href="<?php echo $row_video['video_link']; ?>"
													target="_blank" /> <?php echo $row_video['video_link']; ?></td>
												<td><input type="checkbox" name="checkbox[]"
													value="<?php echo $row_video['id']; ?>"></td>
											</tr>
